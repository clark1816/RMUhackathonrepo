...
if option == 'Hybrid':
    ...
    if value_9:
        ...
        outletpoly = (-2.9296559e-04*value_1) + (5.9018940e-01*value_2) + (6.1102957e-01*value_3) + (2.2976701e+00*value_4) + ( 1.1619338e+00*value_5) + (-6.4515388e+01*value_6) + (1.0759270e-02*value_7) + ( 3.0206018e-03*value_8) + ( -6.9164366e-01*value_9) + -0.2506839632987976 + (value_10*1.0482663e+00)+ (value_11*-6.1003125e-01)+(value_12*5.1095855e-01)+(value_13*1.6000351e-01)+(value_14*-7.9194474e-01)+(value_15*-5.6547500e-02)
